...
<section class="section--narrow">
    <h2>Tapicería y restauración artesanal en Tenerife</h2>
    <p>En <b>Madaya</b> somos especialistas en la <b>restauración y el tapizado de muebles</b>, combinando técnicas artesanales con tejidos ecológicos y de última generación.
        Restaurar tus muebles no solo conserva su valor, también <b>evita el coste y el impacto ambiental de sustituirlos</b>.
        Nuestro objetivo es ofrecerte un resultado duradero, cómodo y respetuoso con el medio ambiente.</p>
</section>

<section class="section--narrow">
    <h2>Materiales sostenibles y tejidos técnicos de alta calidad</h2>
    <p>Seleccionamos tejidos de primera calidad con propiedades diseñadas para mejorar tu día a día:</p>
    <ul>
        <li><b>Antimanchas</b>: Tecnología que facilita la limpieza diaria.</li>
        <li><b>Respetuosos con el medio ambiente</b>: Telas biodegradables, recicladas y libres de sustancias tóxicas.</li>
        <li><b>Protección antiácaros y antivírica</b>: Mayor higiene para un hogar saludable.</li>
    </ul>
    <p>Todos nuestros materiales cumplen <b>estándares de calidad reconocidos internacionalmente</b>, 
    garantizando seguridad, resistencia y respeto por el entorno.</p>
</section>

<section class="section--narrow">
    <h2>Tapicería y restauración para particulares</h2>
    <p>Ofrecemos <b>la reparación y el tapizado de sofás, sillas, butacas, cabeceros, etc.</b> de todo tipo de mobiliario clásico o moderno. Restauramos estructuras respetando la esencia de cada pieza y mejorando su comodidad y acabado.</p>
    <p>Si necesitas <b>tapizar un sofá en Tenerife</b> o recuperar una pieza especial, podemos ayudarte.</p>
    <p>Trabajamos contigo para elegir tejidos, acabados y soluciones que encajen con tu estilo y tu forma de vivir.</p>
    <a href="/servicios.php#particulares" class="btn-small btn--primary">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true" focusable="false">
            <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z"/>
        </svg>
        Ver tapicería para el hogar
    </a>
    <p>También realizamos <b>fabricación a medida</b>, adaptándonos a espacios específicos y necesidades concretas.</p> 
    <a href="/servicios.php#fabricacion" class="btn-small btn--primary">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16"  aria-hidden="true" focusable="false">
            <path d="M9.972 2.508a.5.5 0 0 0-.16-.556l-.178-.129a5 5 0 0 0-2.076-.783C6.215.862 4.504 1.229 2.84 3.133H1.786a.5.5 0 0 0-.354.147L.146 4.567a.5.5 0 0 0 0 .706l2.571 2.579a.5.5 0 0 0 .708 0l1.286-1.29a.5.5 0 0 0 .146-.353V5.57l8.387 8.873A.5.5 0 0 0 14 14.5l1.5-1.5a.5.5 0 0 0 .017-.689l-9.129-8.63c.747-.456 1.772-.839 3.112-.839a.5.5 0 0 0 .472-.334"/>
        </svg>
        Ver fabricación a medida
    </a>
    <p>Si buscas un tapicero en Tenerife con enfoque sostenible, en Madaya encontrarás un taller especializado.</p>
</section>

<section class="section--narrow">
    <h2>Soluciones para empresas y espacios públicos</h2>
    <p>Trabajamos con <b>negocios y entidades en toda la isla de Tenerife</b>, ofreciendo soluciones resistentes, seguras y adaptadas a cada espacio.</p>
    <p>Fabricamos módulos de asiento, protectores acolchados para canchas deportivas, cortinaje técnico y <b>soluciones adaptadas a espacios de uso intensivo</b>.</p>
    <p>Ofrecemos asesoramiento profesional para garantizar resultados duraderos y funcionales en entornos de alto tránsito.</p>
    <a href="/servicios.php#profesionales" class="btn-small btn--primary">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16"  aria-hidden="true" focusable="false">
...
<section class="section--narrow">
    ...
    <p>Antes de desechar tu mueble, <a href="/contacto.php"><b>consúltanos sin compromiso</b></a>. Dar una segunda vida a tus muebles ayuda a reducir residuos y contribuye a un consumo local y responsable.</p>
    <a href="/contacto.php" class="btn-small btn--primary">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true" focusable="false">
            <path d="M4 11a1 1 0 1 1 2 0v1a1 1 0 1 1-2 0zm6-4a1 1 0 1 1 2 0v5a1 1 0 1 1-2 0zM7 9a1 1 0 0 1 2 0v3a1 1 0 1 1-2 0z"/>
            <path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1z"/>
            <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0z"/>
