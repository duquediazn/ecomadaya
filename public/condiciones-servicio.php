...
<section class="section--narrow">
    ...
    <h2>1. Validez del presupuesto</h2>
    ...
    <h2>2. Aceptación del presupuesto y señal inicial</h2>
    ...
    <h2>3. Ajustes del presupuesto por condiciones internas del mueble</h2>
    ...
    <h2>5. Limitaciones de responsabilidad sobre el uso del mueble</h2>
    <p>No se consideran defectos:</p>
    <ul>
    ...
    <h2>6. Tejidos y materiales aportados por el cliente</h2>
    ...
    <h2>7. Devoluciones, cancelaciones y modificaciones</h2>
    <ul>
        ...
        <li>No se aceptan devoluciones en trabajos personalizados (tapicería, fundas a medida, reparación artesanal…).</li>
    </ul>

    <h2>8. Conflictos y resolución</h2>
    <p>Ambas partes se someten al <strong>arbitraje de las oficinas de consumo</strong> de la localidad donde se preste el servicio en caso de desacuerdo o disconformidad.
    Buscamos siempre un acuerdo razonable antes de recurrir a estas vías.</p>

    <h2>9. Recogida y entrega a domicilio</h2>
    ...
    <h2>10. Custodia de muebles en el taller</h2>
    <p>Los muebles terminados deberán recogerse en un plazo razonable.
    En caso de retrasos prolongados no justificados, podrían aplicarse gastos de almacenaje.</p>
</section>
