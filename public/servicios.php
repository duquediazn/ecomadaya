...
<section id="catalogos" class="bg-primary">
    <div class="narrow-container">
        ...
        <div class="cta-buttons">
            <a href="https://www.aquaclean.com/es-es/elige-tu-tela" class="btn btn--secondary link-dark" aria-label="Abrir colección aquaclean en nueva pestaña" target="_blank">
            ...
            <a href="https://www.aquaclean.com/es/simulador-aquaclean/" class="btn btn--secondary link-dark" aria-label="Abrir simulador de sofás en nueva pestaña" target="_blank">
        ...
        <p>También ofrecemos tejidos clásicos, sin tantas certificaciones, ideales para estilos tradicionales o presupuestos ajustados. 
            Puedes explorar nuestros catálogos en el <a class="link-secondary" href="https://maps.app.goo.gl/JrKcn4j2A7xQ6T3N9" target="_blank">taller</a>, o si lo prefieres, podemos <strong> visitarte a domicilio</strong> para ayudarte a elegir <strong>sin compromiso</strong>.</p>
    </div>
