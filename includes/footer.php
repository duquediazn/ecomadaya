    ...
    <section class="row-section-site">
        <div class="footer-col">
            ...
            <div class="social-links">
                ...
                <a href="https://www.instagram.com/madaya1/" target="_blank">
                    <svg class="instagram-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor">
