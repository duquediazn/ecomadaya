...
<section id="catalogos" class="bg-primary">
    <div class="narrow-container">
        ...
        <div class="cta-buttons">
            ...
            <a href="https://www.aquaclean.com/es/simulador-aquaclean/" class="btn btn--secondary dark-link" aria-label="Abrir simulador de sofás en nueva pestaña" target="_blank">
